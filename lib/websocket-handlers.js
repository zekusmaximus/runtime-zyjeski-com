  ...
  initializeHandlers(socket, io) {
    ...
    socket.on('start-monitoring', async (data) => {
      try {
        ...
        error('Error starting monitoring', { error, characterId });
        socket.emit('error', { 
    ...
    socket.on('stop-monitoring', (data) => {
      try {
        ...
        error('Error stopping monitoring', { error, characterId });
        socket.emit('error', { 
    ...
    socket.on('debug-command', async (data) => {
      try {
        ...
        error('Error executing debug command', { error, command, characterId });
    ...
    socket.on('player-intervention', async (data) => {
      try {
        ...
        error('Error applying player intervention', { error, characterId, interventionType: intervention.type });
    ...
    socket.on('request-update', async (data) => {
      try {
        ...
        error('Error triggering manual update', { error, characterId });
        socket.emit('error', { 
    ...
    socket.on('toggle-auto-updates', (data) => {
      try {
        ...
        error('Error toggling auto-updates', { error, characterId, enabled });
        socket.emit('error', { 
