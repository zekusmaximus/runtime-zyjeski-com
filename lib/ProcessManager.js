...
class ProcessManager {
    ...
    async killProcess(processId) {
        // Use KillProcessCommand internally while maintaining backward compatibility
    ...
    async restartProcess(processId) {
        // Use RestartProcessCommand internally while maintaining backward compatibility
        const restartCommand = new RestartProcessCommand(this, processId);

        // canExecute will throw descriptive errors if process cannot be restarted
